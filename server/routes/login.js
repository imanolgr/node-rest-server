...
app.post('/google', async(req, res) => {
    ...
    Usuario.findOne({ email: googleUser.email }, (err, usuarioDB) => {
        ...
        if (usuarioDB) { //si ya se autentificó anteriormente con nuestro sistema
        ...
        } else { //Si el usuario no existe en nuestra base de datos y se ha dado de alta con Google
